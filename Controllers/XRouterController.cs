...
namespace XRouter.Api.Controllers
{
    ...
    public class XRouterController : ControllerBase 
    {
        ...
        public IActionResult GetBlockCount([FromBody] XRouterBaseRequestViewModel viewModel)
        {
            ...
            {
                var blockCountETHResponse = xrouterService.xrGetBlockCount<Blocknet.Lib.Services.Coins.Blocknet.Xrouter.Ethereum.GetBlockCountResponse>
            ...
            {
                var blockCountETCResponse = xrouterService.xrGetBlockCount<Blocknet.Lib.Services.Coins.Blocknet.Xrouter.EthereumClassic.GetBlockCountResponse>
                    (viewModel.Token, viewModel.NodeCount);
            ...
            {
                var blockCountNEOResponse = xrouterService.xrGetBlockCount<Blocknet.Lib.Services.Coins.Blocknet.Xrouter.Neo.GetBlockCountResponse>
                    (viewModel.Token, viewModel.NodeCount);
            ...
            {
                var blockCountXMRResponse = xrouterService.xrGetBlockCount<Blocknet.Lib.Services.Coins.Blocknet.Xrouter.Monero.GetBlockCountResponse>
                    (viewModel.Token, viewModel.NodeCount);

                return Ok(mapper.Map<ViewModels.Monero.GetBlockCountResponseViewModel>(blockCountXMRResponse));
            }

            var blockCountResponse = xrouterService.xrGetBlockCount<Blocknet.Lib.Services.Coins.Blocknet.Xrouter.BitcoinBased.GetBlockCountResponse>
                (viewModel.Token, viewModel.NodeCount);
        ...
        public IActionResult DecodeRawTransaction([FromBody] DecodeRawTransactionRequestViewModel viewModel)
        {
            if (viewModel.Token.Equals("xr::ETH"))
            {
                var decodeRawTransactionETHResponse = xrouterService.xrDecodeRawTransaction<Blocknet.Lib.Services.Coins.Blocknet.Xrouter.Ethereum.GetDecodeRawTransactionResponse>
            ...
            if (viewModel.Token.Equals("xr::ETC"))
            {
                var decodeRawTransactionETCResponse = xrouterService.xrDecodeRawTransaction<Blocknet.Lib.Services.Coins.Blocknet.Xrouter.EthereumClassic.GetDecodeRawTransactionResponse>
                    (viewModel.Token, viewModel.TxHex, viewModel.NodeCount);
            ...
            if (viewModel.Token.Equals("xr::NEO"))
            {
                var decodeRawTransactionNEOResponse = xrouterService.xrDecodeRawTransaction<Blocknet.Lib.Services.Coins.Blocknet.Xrouter.Neo.GetDecodeRawTransactionResponse>
                    (viewModel.Token, viewModel.TxHex, viewModel.NodeCount);
            ...
            if (viewModel.Token.Equals("xr::XMR"))
            {
                var decodeRawTransactionXMRResponse = xrouterService.xrDecodeRawTransaction<Blocknet.Lib.Services.Coins.Blocknet.Xrouter.Monero.GetDecodeRawTransactionResponse>
                    (viewModel.Token, viewModel.TxHex, viewModel.NodeCount);

                return Ok(mapper.Map<ViewModels.Monero.GetDecodeRawTransactionResponseViewModel>(decodeRawTransactionXMRResponse));
            }

            var decodeRawTransactionResponse = xrouterService.xrDecodeRawTransaction<Blocknet.Lib.Services.Coins.Blocknet.Xrouter.BitcoinBased.GetDecodeRawTransactionResponse>
                (viewModel.Token, viewModel.TxHex, viewModel.NodeCount);
        ...
        public IActionResult GetBlockHash([FromBody] BlockHashRequestViewModel viewModel)
        {
            if (viewModel.Token.Equals("xr::ETH"))
            {
                var getBlockHashETHResponse = xrouterService.xrGetBlockHash<Blocknet.Lib.Services.Coins.Blocknet.Xrouter.Ethereum.GetBlockHashResponse>
            ...
            if (viewModel.Token.Equals("xr::ETC"))
            {
                var getBlockHashETCResponse = xrouterService.xrGetBlockHash<Blocknet.Lib.Services.Coins.Blocknet.Xrouter.EthereumClassic.GetBlockHashResponse>
                    (viewModel.Token, viewModel.BlockNumber, viewModel.NodeCount);
            ...
            if (viewModel.Token.Equals("xr::NEO"))
            {
                var getBlockHashNeoResponse = xrouterService.xrGetBlockHash<Blocknet.Lib.Services.Coins.Blocknet.Xrouter.Neo.GetBlockHashResponse>
                    (viewModel.Token, viewModel.BlockNumber, viewModel.NodeCount);
            ...
            if (viewModel.Token.Equals("xr::XMR"))
            {
                var getBlockHashXMRResponse = xrouterService.xrGetBlockHash<Blocknet.Lib.Services.Coins.Blocknet.Xrouter.Monero.GetBlockHashResponse>
                    (viewModel.Token, viewModel.BlockNumber, viewModel.NodeCount);

                return Ok(mapper.Map<ViewModels.Monero.GetBlockHashResponseViewModel>(getBlockHashXMRResponse));
            }

            var blockHashResponse = xrouterService.xrGetBlockHash<Blocknet.Lib.Services.Coins.Blocknet.Xrouter.BitcoinBased.GetBlockHashResponse>
                (viewModel.Token, viewModel.BlockNumber, viewModel.NodeCount);
        ...
        public IActionResult GetBlock([FromBody] BlockRequestViewModel viewModel)
        {
            if (viewModel.Token.Equals("xr::ETH"))
            {
                var getBlockETHResponse = xrouterService.xrGetBlock<Blocknet.Lib.Services.Coins.Blocknet.Xrouter.Ethereum.GetBlockResponse>
            ...
            if (viewModel.Token.Equals("xr::ETC"))
            {
                var getBlockETCResponse = xrouterService.xrGetBlock<Blocknet.Lib.Services.Coins.Blocknet.Xrouter.EthereumClassic.GetBlockResponse>
                    (viewModel.Token, viewModel.BlockHash, viewModel.NodeCount);
            ...
            if (viewModel.Token.Equals("xr::NEO"))
            {
                var getBlockNEOResponse = xrouterService.xrGetBlock<Blocknet.Lib.Services.Coins.Blocknet.Xrouter.Neo.GetBlockResponse>
                    (viewModel.Token, viewModel.BlockHash, viewModel.NodeCount);
            ...
            if (viewModel.Token.Equals("xr::XMR"))
            {
                var getBlockXMRResponse = xrouterService.xrGetBlock<Blocknet.Lib.Services.Coins.Blocknet.Xrouter.Monero.GetBlockResponse>
                    (viewModel.Token, viewModel.BlockHash, viewModel.NodeCount);

                return Ok(mapper.Map<ViewModels.Monero.GetBlockResponseViewModel>(getBlockXMRResponse));
            }

            var blockResponse = xrouterService.xrGetBlock<Blocknet.Lib.Services.Coins.Blocknet.Xrouter.BitcoinBased.GetBlockResponse>
                (viewModel.Token, viewModel.BlockHash, viewModel.NodeCount);
        ...
        public IActionResult GetBlocks([FromBody] BlocksRequestViewModel viewModel)
        {
            if (viewModel.Token.Equals("xr::ETH"))
            {
                var getBlocksETHResponse = xrouterService.xrGetBlocks<Blocknet.Lib.Services.Coins.Blocknet.Xrouter.Ethereum.GetBlocksResponse>
            ...
            if (viewModel.Token.Equals("xr::ETC"))
            {
                var getBlocksETCResponse = xrouterService.xrGetBlocks<Blocknet.Lib.Services.Coins.Blocknet.Xrouter.EthereumClassic.GetBlocksResponse>
                    (viewModel.Token, string.Join(",", viewModel.BlockHashes), viewModel.NodeCount);
            ...
            if (viewModel.Token.Equals("xr::NEO"))
            {
                var getBlocksNEOResponse = xrouterService.xrGetBlocks<Blocknet.Lib.Services.Coins.Blocknet.Xrouter.Neo.GetBlocksResponse>
                    (viewModel.Token, string.Join(",", viewModel.BlockHashes), viewModel.NodeCount);
            ...
            if (viewModel.Token.Equals("xr::XMR"))
            {
                var getBlocksXMRResponse = xrouterService.xrGetBlocks<Blocknet.Lib.Services.Coins.Blocknet.Xrouter.Monero.GetBlocksResponse>
                    (viewModel.Token, string.Join(",", viewModel.BlockHashes), viewModel.NodeCount);

                return Ok(mapper.Map<ViewModels.Monero.GetBlocksResponseViewModel>(getBlocksXMRResponse));
            }

            var blocksResponse = xrouterService.xrGetBlocks<Blocknet.Lib.Services.Coins.Blocknet.Xrouter.BitcoinBased.GetBlocksResponse>
                (viewModel.Token, string.Join(",", viewModel.BlockHashes), viewModel.NodeCount);
        ...
        public IActionResult GetTransaction([FromBody] TransactionRequestViewModel viewModel)
        {
            if (viewModel.Token.Equals("xr::ETH"))
            {
                var getTransactionETHResponse = xrouterService.xrGetTransaction<Blocknet.Lib.Services.Coins.Blocknet.Xrouter.Ethereum.GetTransactionResponse>
            ...
            if (viewModel.Token.Equals("xr::ETC"))
            {
                var getTransactionETCResponse = xrouterService.xrGetTransaction<Blocknet.Lib.Services.Coins.Blocknet.Xrouter.EthereumClassic.GetTransactionResponse>
                    (viewModel.Token, viewModel.TxId, viewModel.NodeCount);
            ...
            if (viewModel.Token.Equals("xr::NEO"))
            {
                var getTransactionNEOResponse = xrouterService.xrGetTransaction<Blocknet.Lib.Services.Coins.Blocknet.Xrouter.Neo.GetTransactionResponse>
                    (viewModel.Token, viewModel.TxId, viewModel.NodeCount);
            ...
            if (viewModel.Token.Equals("xr::XMR"))
            {
                var getTransactionXMRResponse = xrouterService.xrGetTransaction<Blocknet.Lib.Services.Coins.Blocknet.Xrouter.Monero.GetTransactionResponse>
                    (viewModel.Token, viewModel.TxId, viewModel.NodeCount);

                return Ok(mapper.Map<ViewModels.Monero.GetTransactionResponseViewModel>(getTransactionXMRResponse));
            }

            var transactionResponse = xrouterService.xrGetTransaction<Blocknet.Lib.Services.Coins.Blocknet.Xrouter.BitcoinBased.GetTransactionsResponse>
                (viewModel.Token, viewModel.TxId, viewModel.NodeCount);
        ...
        {   
            if (viewModel.Token.Equals("xr::ETH"))
            {
                var getTransactionsETHResponse = xrouterService.xrGetTransactions<Blocknet.Lib.Services.Coins.Blocknet.Xrouter.Ethereum.GetTransactionsResponse>
            ...
            if (viewModel.Token.Equals("xr::ETC"))
            {
                var getTransactionsETCResponse = xrouterService.xrGetTransactions<Blocknet.Lib.Services.Coins.Blocknet.Xrouter.EthereumClassic.GetTransactionsResponse>
                    (viewModel.Token, string.Join(",", viewModel.TxIds), viewModel.NodeCount);
            ...
            if (viewModel.Token.Equals("xr::NEO"))
            {
                var getTransactionsNEOResponse = xrouterService.xrGetTransactions<Blocknet.Lib.Services.Coins.Blocknet.Xrouter.Neo.GetTransactionsResponse>
                    (viewModel.Token, string.Join(",", viewModel.TxIds), viewModel.NodeCount);
            ...
            if (viewModel.Token.Equals("xr::XMR"))
            {
                var getTransactionsXMRResponse = xrouterService.xrGetTransactions<Blocknet.Lib.Services.Coins.Blocknet.Xrouter.Monero.GetTransactionsResponse>
                    (viewModel.Token, string.Join(",", viewModel.TxIds), viewModel.NodeCount);

                return Ok(mapper.Map<ViewModels.Monero.GetTransactionsResponseViewModel>(getTransactionsXMRResponse));
            }

            var transactionsResponse = xrouterService.xrGetTransactions<Blocknet.Lib.Services.Coins.Blocknet.Xrouter.BitcoinBased.GetTransactionsResponse>
                (viewModel.Token, string.Join(",", viewModel.TxIds), viewModel.NodeCount);
        ...
        public IActionResult SendTransaction([FromBody]SendTransactionRequestViewModel viewModel)
        {
            if (viewModel.Token.Equals("xr::ETH"))
            {
                var sendTransactionETHResponse = xrouterService.xrSendTransaction<Blocknet.Lib.Services.Coins.Blocknet.Xrouter.Ethereum.SendTransactionResponse>
            ...
            if (viewModel.Token.Equals("xr::ETC"))
            {
                var sendTransactionETCResponse = xrouterService.xrSendTransaction<Blocknet.Lib.Services.Coins.Blocknet.Xrouter.EthereumClassic.SendTransactionResponse>
                    (viewModel.Token, viewModel.SignedTx, viewModel.NodeCount);
            ...
            if (viewModel.Token.Equals("xr::NEO"))
            {
                var sendTransactionNEOResponse = xrouterService.xrSendTransaction<Blocknet.Lib.Services.Coins.Blocknet.Xrouter.Neo.SendTransactionResponse>
                    (viewModel.Token, viewModel.SignedTx, viewModel.NodeCount);
            ...
            if (viewModel.Token.Equals("xr::XMR"))
            {
                var sendTransactionXMRResponse = xrouterService.xrSendTransaction<Blocknet.Lib.Services.Coins.Blocknet.Xrouter.Monero.SendTransactionResponse>
                    (viewModel.Token, viewModel.SignedTx, viewModel.NodeCount);

                return Ok(mapper.Map<ViewModels.Monero.SendTransactionResponseViewModel>(sendTransactionXMRResponse));
            }

            var sendTransactionResponse = xrouterService.xrSendTransaction<Blocknet.Lib.Services.Coins.Blocknet.Xrouter.BitcoinBased.SendTransactionResponse>
                (viewModel.Token, viewModel.SignedTx, viewModel.NodeCount);
